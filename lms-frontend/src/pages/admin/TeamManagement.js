...
import {
  ...
  Divider, Stack, Avatar, Badge, Snackbar, Alert
} from '@mui/material';
import {
  ...
  renderCell: (params) => (
    <Stack direction="row" spacing={0.5}>
      ...
      {user?.user_type === 'STAFF' && (
        <Tooltip title="Request Team Deletion" arrow>
          <IconButton 
            size="small"
            onClick={() => handleOpenRequestDialog(params.row)}
            sx={{ 
              bgcolor: 'action.hover',
